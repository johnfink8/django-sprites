...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sprite.ready'
        db.add_column('sprites_sprite', 'ready', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sprite.ready'
        db.delete_column('sprites_sprite', 'ready')
